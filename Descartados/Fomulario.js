...
const validarformulario = (e) =>{
    switch (e.target.name){
        ...
        break;
        case "apellido":
            validarCampo(expresiones.apellido, e.target.name);
        break;
        case "numero_de_documento":
            validarCampo(expresiones.numero_de_documento, e.target.name);
        break;
        case "numero_de_celular":
            validarCampo(expresiones.numero_de_celular,e.target.name);
        break;
        case "correo":
...
e.preventDefault();
    ...
    if(campos.nombre && campos.apellido && campos.numero_de_documento && campos.numero_de_celular && campos.correo && campos.password && campos.password2 && terminos.ariaChecked){
    formulario.reset();
